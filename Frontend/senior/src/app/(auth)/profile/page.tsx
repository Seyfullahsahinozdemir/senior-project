    ...
    <div className="container mx-auto my-5 p-5">
      <div className="md:flex no-wrap md:-mx-2 ">
        ...
        <div className="w-full md:w-9/12 mx-2 h-64">
          <div className="bg-white p-3 shadow-sm rounded-md border-gray-50 border">
            ...
            <div className="text-gray-700">
              <div className="grid md:grid-cols-2 text-sm">
                ...
                <div className="grid grid-cols-2">
                  ...
                  <div className="px-4 py-2">{user?.preferences?.address}</div>
                </div>
                <div className="grid grid-cols-2">
              ...
              {selectedButton === "posts" ? (
                ...
                selectedButton === "items" && (
                  <div className="w-full">
                    ...
                    <div className="flex gap-3 items-center px-4 py-2 mt-4 pl-4 bg-white rounded-md shadow-md hover:shadow-lg transition duration-300 w-full border border-gray-50">
                      <div className="text-lg font-semibold">Choose tags:</div>
            ...
            {selectedButton === "posts" ? (
              <>
                ...
                {posts.length == 0 ? (
                  <p className="font-thin text-gray-500">
                    No posts exist please add new one.
                  </p>
                ) : (
              ...
              selectedButton === "items" && (
                <>
                  ...
                  {items.length == 0 ? (
                    <p className="font-thin text-gray-500">
                      No items exist please add new one.
                    </p>
                  ) : (
                    <div className="flex justify-center mt-4">
                      <button
